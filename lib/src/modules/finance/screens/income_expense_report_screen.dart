...
class _IncomeExpenseReportScreenState extends State<IncomeExpenseReportScreen> {
  ...
  Future<void> _descargarReporteFinanzas() async {
    try {
      ...
      final pdfBytes = await FinanceService.downloadReporteFinanzas(
      ...
      final anchor = html.AnchorElement(href: url)
        ..setAttribute('download', 'reporte_finanzas_${DateTime.now().millisecondsSinceEpoch}.pdf')
        ..click();
